...
<template>
  <header class="bg-indigo-500">
    ...
    <div class="flex flex-col">
      <h1 class="font-mono text-indigo-900 text-6xl font-bold">
        Bienvenido a ISCLAB
      </h1>

      <p class="font-mono text-indigo-900 text-5xl">
        Donde buscamos perdurar en el tiempo!
      </p>
    </div>
  </header>
  <!--Divs del diseño-->
  <div class="font-mono bg-yellow-500 w-500 h-300 flex flex-row flex-wrap">
    <div class="w-1/2 hover:border-8 border-solid border-black">
      <h1 class="text-5xl text-left m-20 text-center font-bold ">¿Cual es el objetivo?</h1>
    </div>
    <div class="w-1/2 ">
      <p class="m-10 text-4xl hover:border-8 border-solid border-black">
        Atraer estudiantes a crear los proyectos que tengan en mente o desarrollar proyectos ya existentes, queremos tener un lugar donde los alumnos del ITSMOTUL
        pueden recibir asesoramiento.
      </p>
    </div>
  </div>

  <div class="bg-emerald-500 w-500 h-300 flex flex-row flex-wrap">
    <div class="font-mono text-5xl w-1/2 text-center font-bold hover:border-8 border-solid border-black">
      <h1 class="mb-10 m-12 ">¿Tienes algun proyecto en mente?</h1>
      <h1 class="mb-10 m-4">¿Te interesaria desarrollar un proyecto?</h1>
    </div>

    <div class="w-1/2">
      <p class="m-10 text-4xl hover:border-8 border-solid border-black">
        Unete a este movimiento y deja volar tu imaginación,
        este es el lugar indicado donde podras convivir con estudiantes
        igual de apasionados que tu para compartir opniones y mejorar.
        Contaras con la ayuda de maestros especializados en el tema.
        
      </p>
    </div>
  </div>

  <div class="font-mono bg-purple-600 w-500 h-300 flex flex-row flex-wrap">
    <div class="text-5xl w-1/2 font-bold hover:border-8 border-solid border-black">
      <h1 class="m-20 text-center">¿Como puedo unirme al equipo?</h1>
    </div>
    <div class="w-1/2 ">
      <p class="m-10 text-4xl hover:border-8 hover:border-solid border-black" >
        Crea tu solicitud y enviala al correo que aparece en la parte final de la página
        donde pongas tus datos básicos: Nombre completo, carrera, numero de control, nombre del proyecto
        y una pequeña descripción donde nos hables de donde surgió.
      </p>
    </div>
  </div>

  <div class="font-mono bg-rose-600">
    <div class="text-left text-3xl">
      <h1 class="text-center ">Contactanos:Iverson.19070044@itsmotul.edu.mx</h1>
    </div>
  </div>
</template>
